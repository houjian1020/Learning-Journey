...
/**
 * 主题模式：一个生产者=====>多个队列（根据key模糊匹配）=======>多个消费者
 * 特点：根据key模糊匹配发送到不同的队列，更加灵活; *代表一个单词  #代表0或多个
...
public class TopicProducer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
             ...
             * body：发送给消费者的消息
             */
            String message1 = "topic-info RabbitMQ!";
            channel.basicPublish(EXCHANGE_NAME, "topic.info", MessageProperties.PERSISTENT_TEXT_PLAIN, message1.getBytes());
            String message2 = "topic-error RabbitMQ!";
            channel.basicPublish(EXCHANGE_NAME, "error.info", MessageProperties.PERSISTENT_TEXT_PLAIN, message2.getBytes());
